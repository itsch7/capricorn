...
<?php
        ...
        ?>
        <?php 
        $sql = "SELECT p.ProductID,p.Slug, p.Name as ProductName,p.Price ,pi.ImageURL
        FROM products p
        INNER JOIN productimages pi ON p.ProductID = pi.ProductID where pi.isMain =true";
        ...
        <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
                ...
                if($result->num_rows > 0){
                        while($row = $result->fetch_assoc()){
                                ...
                                <a class='cat-block' style='align-items:start; row-gap:20px'>
                                    <figure>
                                        <span>
